namespace MicroMapper.UnitTests
{
    ...
    namespace Regression
    {
        ...
        public class Mapper_fails_to_map_custom_mappings_when_mapping_collections_for_an_interface
        {
            public Mapper_fails_to_map_custom_mappings_when_mapping_collections_for_an_interface()
            {
                Setup();
            }
