namespace MicroMapper
{
    ...
    public interface IMapperConfigurationContext
    {
        ...
        /// </summary>
        /// <param name="startingWith">Prefix of members to ignore.
        /// Call this before all other maps created.</param>
        void AddGlobalIgnore(string startingWith);

        /// <summary>
        /// Initializes the mapper with the supplied configuration. Runtime optimization complete
        /// after this method is called. This is the preferred means to configure MicroMapper.
        /// </summary>
        /// <param name="action">Delegated initialization action</param>
        /// <see cref="IConfiguration"/>
        void Initialize(Action<IConfiguration> action);

        /// <summary>
        /// Gets or sets whether to AllowNullDestinationValues. When set, destination can have
        /// null values. Defaults to true. This does not affect simple types, only complex ones.
        /// </summary>
        bool AllowNullDestinationValues { get; set; }

        /// <summary>
        /// Creates a mapping configuration from the <typeparamref name="TSource"/> type to the
        /// <typeparamref name="TDestination"/> type.
        /// </summary>
        ...
        /// <summary>
        /// Creates a mapping configuration from the <typeparamref name="TSource"/> type to the
        /// <typeparamref name="TDestination"/> type. Specify the member list to validate against
        ...
        /// <summary>
        /// Create a mapping configuration from the source type to the destination type. Use this
        /// method when the source and destination type are known at runtime and not compile time.
        /// </summary>
        ...
        /// <summary>
        /// Creates a mapping configuration from the source type to the destination type. Specify
        /// the member list to validate against during configuration validation.
        /// </summary>
        /// <param name="sourceType">Source type</param>
        /// <param name="destinationType">Destination type</param>
        /// <param name="memberList">Member list to validate</param>
        ...
        /// </summary>
        /// <param name="profileName">Profile name</param>
        /// <param name="profileConfiguration">Delegated profile configuration action</param>
        ...
        /// <summary>
        /// Add an existing profile type. Profile will be instantiated and added to the
        /// configuration.
        /// </summary>
        ...
        /// <summary>
        /// Returns all configured type maps created.
        /// </summary>
        ...
        /// <see cref="MicroMapperConfigurationException"/> for each problem.
        /// </summary>
        /// <exception cref="MicroMapperConfigurationException"></exception>
