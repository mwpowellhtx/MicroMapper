namespace MicroMapper.Mappers
{
    ...
    public class ObjectMapperCollection : IObjectMapperCollection
    {
        ...
        private static IEnumerable<IObjectMapper> GetDefaultMappers()
        {
            ...
            // Specifying mappers via ctor args was unnecessary.
            yield return new TypeMapMapper();
            yield return new AssignableArrayMapper();
            yield return new FlagsEnumMapper();
            yield return new EnumMapper();
            yield return new MultidimensionalArrayMapper();
        ...
        /// </summary>
        public TypeMapMapper TypeMap
        {
            get { lock (_collection) return _collection.OfType<TypeMapMapper>().SingleOrDefault(); }
        }
        ...
        /// <summary>
        /// Gets or sets an <see cref="IObjectMapper" /> corresponding to the
        /// <paramref name="index" />.
        /// </summary>
        /// <param name="index"></param>
        /// <returns></returns>
