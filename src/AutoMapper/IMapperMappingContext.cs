...
namespace AutoMapper
{
    ...
    /// 
    /// </summary>
    public interface IMapperMappingContext
    {
        /// <summary>
        ...
        /// <summary>
        /// Execute a mapping from the source object to a new destination object. The source type
        /// is inferred from the source object.
        /// </summary>
        ...
        /// <typeparamref name="TDestination"/> types and execute the map. Source type is
        /// inferred from the source object .
        /// </summary>
        /// <typeparam name="TDestination">Destination type to use</typeparam>
        /// <param name="source">Source object to map from</param>
        /// <returns>Mapped destination object</returns>
        ...
        /// destination object. Use this method when the source and destination types are not
        /// known until runtime.
        /// </summary>
        /// <param name="source">Source object to map from</param>
